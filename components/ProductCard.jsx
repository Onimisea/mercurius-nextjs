...
const ProductCard = ({ product }) => {
  ...
  return (
    <section className="bg-white sm2:m-4 p-6 shadow-md rounded-lg relative text-center cursor-pointer group w-[250px]">
      ...
      <img
        src={fiUrl}
        alt={product.name}
        className="w-[250px] h-[250px] object-contain duration-300"
      />
