...
const FlashSlider = () => {
  ...
  return (
    <section className="w-full mx-auto p-6 bg-slate-200 group relative overflow-x-scroll">
      <section className="flex items-center whitespace-nowrap overflow-x-scroll">
