            ...
            <section className="w-full bg-white my-3 lg:mt-8 sm2:text-md md:text-lg">
              {cart.map((item) => {
                ...
                return (
                  <section
                    key={item.id}
                    className="flex md:items-center sm2:justify-between flex-wrap md:my-3 md:p-3 border-b-2 my-3 py-3 text-sm sm2:text-md md:text-lg"
                  >
                    <section className="w-[40px] h-[40px] sm2:w-[60px] sm2:h-[60px] md:w-[80px] md:h-[80px] rounded-md">
                      <img
                        src={fiUrl}
                        alt={item.name}
                    ...
                    <section className="w-[35%] sm2:w-[17%] flex items-center justify-center space-x-2">
                      <section
                    ...
                    <section className="w-[60%] sm2:w-[18%] relative flex items-center justify-between sm2:flex-col sm2:items-start">
                      <section className="font-semibold">
                        ₦{numbersWithCommas(item.price * item.qty)}
                      </section>
                      <section
                        className="md:mt-2 cursor-pointer text-red-700 hover:text-black duration-300"
                        onClick={() => {
                          removeFromCart(item);
