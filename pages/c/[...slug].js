...
export default function CategoryPage({}) {
  ...
  useEffect(() => {
    if (router.isReady) {
      const categories = fetch("https://mercurius-api-production.up.railway.app/api/inventory/c/")
        .then((res) => res.json())
        .then((catData) => {
      ...
      const products = fetch("https://mercurius-api-production.up.railway.app/api/inventory/")
        .then((res) => res.json())
        .then((prodData) => {
...
export const getServerSideProps = async ({ req }) => {
  ...
  const products = await fetch("https://mercurius-api-production.up.railway.app/api/inventory/").then(
    (res) => res.json()
  );
